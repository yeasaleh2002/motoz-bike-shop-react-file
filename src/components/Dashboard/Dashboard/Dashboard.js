...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      ...
      {/* <Link  style={{textDecoration: 'none'}}  to="/products"> <Button color="inherit">Products</Button> </Link>
      <Link  style={{textDecoration: 'none'}}  to="/rating"> <Button color="inherit">Products</Button> </Link>
